...
export const initialOrders = [
  {
    ...
    restaurantId: 'r-5',
    items: [
      { id: 'r-5-i-1', name: 'Tonkotsu Ramen', price: 16.0, quantity: 1 },
      { id: 'r-5-i-3', name: 'Gyoza (6 pc)', price: 7.5, quantity: 1 },
    ],
    subtotal: 23.5,
    deliveryFee: 2.49,
    discount: 0,
  ...
  },
  {
    ...
    restaurantId: 'r-2',
    items: [
      { id: 'r-2-i-1', name: 'The Classic', price: 11.5, quantity: 2 },
      { id: 'r-2-i-4', name: 'Fries', price: 4.5, quantity: 1 },
    ],
    subtotal: 27.5,
    deliveryFee: 1.99,
    discount: 3.5,
  ...
  new: [
    {
      ...
      items: [
        { id: 'r-1-i-1', name: 'Margherita', price: 13.5, quantity: 1 },
        { id: 'r-1-i-4', name: 'Burrata Salad', price: 12.0, quantity: 1 },
      ],
      total: 25.5,
    ...
    },
    {
      id: 'ord-K9XR1',
      customerName: 'Owen T.',
      items: [{ id: 'r-1-i-2', name: 'Funghi', price: 16.0, quantity: 2 }],
      total: 32.0,
  ...
  preparing: [
    {
      ...
      customerName: 'Rae P.',
      items: [
        { id: 'r-1-i-3', name: 'Salsiccia', price: 17.5, quantity: 1 },
        { id: 'r-1-i-1', name: 'Margherita', price: 13.5, quantity: 1 },
      ],
      total: 31.0,
  ...
  ready: [
    {
      ...
      items: [
        { id: 'r-1-i-1', name: 'Margherita', price: 13.5, quantity: 1 },
        { id: 'r-1-i-5', name: 'Tiramisu', price: 7.5, quantity: 1 },
      ],
      total: 21.0,
  ...
  completed: [
    {
      id: 'ord-P9X22',
      customerName: 'Sam K.',
      items: [{ id: 'r-1-i-2', name: 'Funghi', price: 16.0, quantity: 1 }],
      total: 16.0,
    ...
    },
    {
      id: 'ord-J11HQ',
      customerName: 'Kai V.',
      items: [{ id: 'r-1-i-1', name: 'Margherita', price: 13.5, quantity: 3 }],
      total: 40.5,
...
export const initialPayouts = [
  { id: 'p-1', accountId: 'a-7', name: 'Owen Reyes', type: 'driver', amount: 412.5, requestedAt: '2026-05-13', status: 'pending' },
  { id: 'p-2', accountId: 'a-2', name: 'Junebug Burgers', type: 'merchant', amount: 2188.4, requestedAt: '2026-05-12', status: 'pending' },
  { id: 'p-3', accountId: 'a-8', name: 'Iris Mendez', type: 'driver', amount: 308.2, requestedAt: '2026-05-11', status: 'approved' },
  { id: 'p-4', accountId: 'a-1', name: 'Cinque Pizzeria', type: 'merchant', amount: 1942.0, requestedAt: '2026-05-09', status: 'approved' },
  { id: 'p-5', accountId: 'a-10', name: 'Sasha Park', type: 'driver', amount: 124.8, requestedAt: '2026-05-14', status: 'pending' },
];
...
export const promoCodes = [
  { code: 'NOMNOM15', label: 'Giảm 15% cho đơn hàng, tối đa 10 USD.', kind: 'percent', amount: 15, cap: 10 },
  { code: 'WELCOME5', label: 'Giảm 5 USD cho mọi đơn hàng.', kind: 'flat', amount: 5 },
  { code: 'FREEFEE', label: 'Miễn phí giao hàng.', kind: 'flat', amount: 2.49 },
];
...
export const merchantDailyRevenue = [
  ...
  { day: 'Wed', revenue: 742 },
  { day: 'Thu', revenue: 690 },
  { day: 'Fri', revenue: 1124 },
  { day: 'Sat', revenue: 1612 },
  { day: 'Sun', revenue: 1330 },
];

export const merchantTopItems = [
  { name: 'Margherita', sold: 184, revenue: 2484 },
  { name: 'Funghi', sold: 96, revenue: 1536 },
  { name: 'Salsiccia', sold: 71, revenue: 1242 },
  { name: 'Burrata Salad', sold: 58, revenue: 696 },
];
...
export const driverDailyEarnings = [
  ...
  { day: 'Wed', earnings: 82 },
  { day: 'Thu', earnings: 71 },
  { day: 'Fri', earnings: 112 },
  { day: 'Sat', earnings: 138 },
  { day: 'Sun', earnings: 96 },
];

export const adminGmvWeekly = [
  { week: 'W1', gmv: 184000, orders: 5120 },
  { week: 'W2', gmv: 198000, orders: 5402 },
  { week: 'W3', gmv: 212000, orders: 5780 },
  { week: 'W4', gmv: 228000, orders: 6100 },
  { week: 'W5', gmv: 251000, orders: 6520 },
  { week: 'W6', gmv: 268000, orders: 6890 },
  { week: 'W7', gmv: 281000, orders: 7140 },
  { week: 'W8', gmv: 297000, orders: 7480 },
];
