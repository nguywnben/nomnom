      ...
      >
        <div className="space-y-base">
          ...
          <div className="grid grid-cols-2 gap-sm border-y border-hairline py-sm text-body-sm">
            ...
            <div><div className="text-caption text-body">Số điện thoại</div><div className="mt-1 text-ink">{selectedAccount?.phone && selectedAccount.phone !== 'null' ? selectedAccount.phone : 'Chưa cập nhật'}</div></div>
